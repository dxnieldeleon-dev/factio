...
export const TAX_REGIMES: SatItem[] = [
  ...
  {
    code: "625",
    name: "Actividades Empresariales con ingresos a través de Plataformas Tecnológicas",
  },
...
export const COMMON_SAT_KEYS: SatItem[] = [
  ...
  { code: "81112103", name: "Diseño y desarrollo de sitios web" },
  { code: "82101500", name: "Servicios de publicidad" },
  { code: "82101802", name: "Diseño y producción de material publicitario" },
  { code: "82101903", name: "Gestión de redes sociales" },
  { code: "82141504", name: "Diseño de identidad de marca (logotipo)" },
  { code: "82141500", name: "Diseño editorial e ilustración" },
  { code: "82131604", name: "Sesión fotográfica en estudio" },
  { code: "82131600", name: "Cobertura fotográfica de eventos" },
  { code: "82131601", name: "Fotografía aérea (dron)" },
  { code: "82111804", name: "Traducción de documentos" },
  { code: "82111500", name: "Redacción técnica" },
  { code: "82111801", name: "Edición de textos" },
  { code: "85151600", name: "Consulta y planes de nutrición" },
  { code: "85121608", name: "Consulta de psicología" },
  { code: "85121502", name: "Consulta médica general" },
  { code: "85122101", name: "Fisioterapia y rehabilitación" },
  { code: "86132001", name: "Coaching ejecutivo" },
  { code: "86132000", name: "Capacitación empresarial" },
  { code: "86101810", name: "Talleres y cursos de habilidades" },
  { code: "81101508", name: "Proyecto arquitectónico y diseño de interiores" },
  { code: "81101513", name: "Dirección y supervisión de obra" },
  { code: "84111500", name: "Servicios de contabilidad" },
  { code: "84111504", name: "Teneduría de libros" },
  { code: "84111505", name: "Cálculo y timbrado de nómina" },
  { code: "80121601", name: "Asesoría legal y elaboración de contratos" },
  { code: "80121707", name: "Representación en disputas laborales" },
  { code: "91101701", name: "Corte y tinte de cabello" },
  { code: "91101601", name: "Tratamientos faciales" },
  { code: "91101600", name: "Tratamientos corporales / spa" },
  { code: "91101504", name: "Entrenamiento físico personalizado" },
  { code: "91101501", name: "Servicios de gimnasio o centro de salud" },
