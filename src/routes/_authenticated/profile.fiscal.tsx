...
import { FiscalProfileForm } from "@/features/profile/fiscal-profile-form";
import { loadCompanyProfile } from "@/features/profile/company-profile";

export const Route = createFileRoute("/_authenticated/profile/fiscal")({ component: FiscalProfilePage });
